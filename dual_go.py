...
#    TriangleServer's self.channel is now self.channels
#
...
class TriangleServer(object):
    ...
    def _create_services(self):
        ...
        self.runner = ShowRunner(self.triangle_model,
                                 self.triangle_simulator,
                                 args.max_time,
                                 self.triangle_simulator.get_channel())
...
if __name__ == '__main__':
    ...
    print ("Using Triangle Simulator at {}:{}-{}".format(sim_host, sim_port, sim_port + NUM_CHANNELS - 1))
    ...
    for i in range(NUM_CHANNELS):
        ...
        full_triangle = triangle.load_triangles(model)
        channels.append(TriangleServer(full_triangle, model, args))
